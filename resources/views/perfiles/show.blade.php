...
@section('content')
    ...
    <div class="container">
                ...
                @foreach($recetas as $key => $receta)
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h3>{{ $receta->titulo }}</h3>
                                <a class="btn btn-primary d-block mt-4 text-uppercase font-weight-bold" href="{{route('recetas.show',['receta' => $receta->id ])}}">Ver Receta</a>
                            </div>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="d-flex justify-content-center">{{$recetas->links("pagination::bootstrap-4")}}</div>
    </div>
@endsection